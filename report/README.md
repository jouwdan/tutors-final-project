...
- [The Tutors Open Source Project](#the-tutors-open-source-project)
  ...
  - [2. Educational Technology (EdTech)](#2-educational-technology-edtech)
  - [3. State of the art](#3-state-of-the-art)
    - [3.1 NodeJS \& TypeScript](#31-nodejs--typescript)
    - [3.2 Frontend Frameworks](#32-frontend-frameworks)
    - [3.3 CSS Frameworks \& UI Libraries](#33-css-frameworks--ui-libraries)
    - [3.4 Build Systems](#34-build-systems)
    - [3.5 Monorepos](#35-monorepos)
  - [4. Architecture](#4-architecture)
    - [4.1 Under the hood](#41-under-the-hood)
    - [4.2 Tutors Generators](#42-tutors-generators)
      - [4.2.1 Tutors Lib](#421-tutors-lib)
      - [4.2.2 Tutors JSON](#422-tutors-json)
      - [4.2.3 Tutors HTML](#423-tutors-html)
    - [4.3 Course Reader](#43-course-reader)
      - [4.3.1 Tutors Course Reader](#431-tutors-course-reader)
      - [4.3.2 Tutors Reader Lib](#432-tutors-reader-lib)
      - [4.3.3 Tutors UI](#433-tutors-ui)
  - [5. Implementation](#5-implementation)
    - [5.1 Phase 1 (June 2021 - August 2021)](#51-phase-1-june-2021---august-2021)
      - [5.1.1 Initial Technologies \& User Experience](#511-initial-technologies--user-experience)
      - [5.1.2 Initial Setup \& Research](#512-initial-setup--research)
      - [5.1.3 Implementing DaisyUI](#513-implementing-daisyui)
    - [5.2 Phase 2 (August 2021 - April 2022)](#52-phase-2-august-2021---april-2022)
      - [5.2.1 Tutors Tech Team](#521-tutors-tech-team)
        - [5.2.1.1 Red Hat Onboarding](#5211-red-hat-onboarding)
        - [5.2.1.2 Working with the Tutors Tech Team](#5212-working-with-the-tutors-tech-team)
        - [5.2.1.3 A new Tutors domain \& branding](#5213-a-new-tutors-domain--branding)
        - [5.2.1.4 Meeting Red Hat](#5214-meeting-red-hat)
    - [5.3 Phase 3 (April 2022 - August 2022)](#53-phase-3-april-2022---august-2022)
      - [5.3.1 The Tutors Monorepo](#531-the-tutors-monorepo)
        - [5.3.1.1 Turborepo](#5311-turborepo)
        - [5.3.1.2 Creating the Tutors Monorepo](#5312-creating-the-tutors-monorepo)
      - [5.3.2 The Tutors Design System](#532-the-tutors-design-system)
      - [5.3.3 Netlify Open Source License](#533-netlify-open-source-license)
    - [5.4 Phase 4 (August 2022 - March 2023)](#54-phase-4-august-2022---march-2023)
      - [5.4.1 Developer Events](#541-developer-events)
        - [5.4.1.1 Hacktoberfest 2022](#5411-hacktoberfest-2022)
        - [5.4.1.2 GDG Glasgow 2022](#5412-gdg-glasgow-2022)
      - [5.4.2 The Next Generation of Tutors](#542-the-next-generation-of-tutors)
        - [5.4.2.1 SvelteKit \& Skeleton](#5421-sveltekit--skeleton)
        - [5.4.2.2 SvelteKit](#5422-sveltekit)
        - [5.4.2.3 Skeleton, Storybook \& tutors-ui components](#5423-skeleton-storybook--tutors-ui-components)
        - [5.4.2.4 An updated monorepo structure](#5424-an-updated-monorepo-structure)
        - [5.4.2.5 Preparing for release](#5425-preparing-for-release)
        - [5.4.2.6 Release Automation](#5426-release-automation)
      - [5.4.3 Holopin](#543-holopin)
        - [5.4.3.1 Oscar the Owl](#5431-oscar-the-owl)
        - [5.4.3.2 Evolving badges](#5432-evolving-badges)
  - [6. Conclusion + Further work](#6-conclusion--further-work)
    - [6.1 Reflection](#61-reflection)
      - [6.1.1 What I have learned](#611-what-i-have-learned)
      - [6.1.2 What I would do differently](#612-what-i-would-do-differently)
      - [6.1.3 Problems encountered](#613-problems-encountered)
    - [6.2 Future contributions / Further Work](#62-future-contributions--further-work)
...
### 3.3 CSS Frameworks & UI Libraries
...
### 5.1 Phase 1 (June 2021 - August 2021)

#### 5.1.1 Initial Technologies & User Experience
...
### 5.2 Phase 2 (August 2021 - April 2022)

#### 5.2.1 Tutors Tech Team

##### 5.2.1.1 Red Hat Onboarding
...
##### 5.2.1.2 Working with the Tutors Tech Team
...
##### 5.2.1.3 A new Tutors domain & branding
...
### 5.3 Phase 3 (April 2022 - August 2022)

#### 5.3.1 The Tutors Monorepo
...
##### 5.3.1.2 Creating the Tutors Monorepo
...
#### 5.3.2 The Tutors Design System
...
#### 5.3.3 Netlify Open Source License
...
### 5.4 Phase 4 (August 2022 - March 2023)

#### 5.4.1 Developer Events

##### 5.4.1.1 Hacktoberfest 2022
...
#### 5.4.2 The Next Generation of Tutors

##### 5.4.2.1 SvelteKit & Skeleton
...
##### 5.4.2.3 Skeleton, Storybook & tutors-ui components
...
##### 5.4.2.4 An updated monorepo structure
...
#### 6.1.2 What I would do differently
...
### 6.2 Future contributions / Further Work
